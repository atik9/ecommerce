...
<!-- Mirrored from coderthemes.com/ubold/layouts/dark/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Dec 2018 13:01:24 GMT -->
<head>
    <meta charset="utf-8" />
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                <a href="{{URL::to('/ecomerce')}}">Dashboard</a>
                            </li>
                            <li>
                        ...
                        <div class="card-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-hover table-centered m-0">
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{asset('public/assets/images/users/user-2.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{asset('public/assets/images/users/user-3.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{asset('public/assets/images/users/user-4.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{asset('public/assets/images/users/user-5.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{asset('public/assets/images/users/user-6.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
...
<div class="right-bar">
    ...
    <div class="slimscroll-menu">
        ...
        <div class="user-box">
            <div class="user-img">
                <img src="{{asset('public/assets/images/users/user-1.jpg')}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
...
<!-- Mirrored from coderthemes.com/ubold/layouts/dark/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Dec 2018 13:02:34 GMT -->
</html>